    ...
    <div className="home-page">
      ...
      <div className="hero-section">
        <div className="hero-content">
          <h1>Welcome to Go-Rent, {user?.name || 'User'}!</h1>
          <p>Find the perfect car for your next adventure. Choose from our premium fleet of rental cars.</p>
          <div className="hero-stats">
            ...
            <div className="stat">
              <span className="stat-number">{cars.filter(car => car.available).length}</span>
              <span className="stat-label">Ready to Rent</span>
            </div>
            <div className="stat">
